...
import Button from './Button';
  const Profile = () => {
    ...
    useEffect(() => {
      fetch('https://nice-jade-cocoon-gear.cyclic.app/api/me', {
        headers: {
          'Authorization': localStorage.getItem('token') // Assuming the JWT token is stored in localStorage under the key 'token'
        }
      })
      ...
      return (
        <div className="bg-black text-white h-screen">
          <div className="pt-20 flex flex-col items-center">
            <h1 className="text-5xl mb-4">Log in first</h1>
            <img
              src="https://www.icegif.com/wp-content/uploads/2023/08/icegif-232.gif"
              alt="Log in gif"
